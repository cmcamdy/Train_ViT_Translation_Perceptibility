...
with_scale, with_trans = True, True
...
def init_parser():
    ...
    parser.add_argument('--dataset',
                        default='CIFAR10',
                        choices=[
                            'CIFAR10', 'CIFAR100', 'Tiny-Imagenet', 'SVHN',
                            'CINIC', 'WHU-RS19', 'WHU-RS19-s',
                            'UCMerced_LandUse', 'EuroSAT', 'EuroSATallBands',
                            'flowers', 'cars'
                        ],
                        type=str,
    ...
    if args.aa == True:
        ...
        if 'CIFAR' in args.dataset:
            ...
            augmentations += [SVHNPolicy()]
                ...
                'WHU-RS19', 'WHU-RS19-s', 'UCMerced_LandUse', 'EuroSAT',
                'EuroSATallBands', 'flowers', 'cars'
        ]:
...
def affine_infer(model,
    ...
    print(
        ...
        .format(loss, loss_oral, loss_translated * args.alpha_trans,
                loss_scale_mse * lambda_trans, loss_trans_mse * lambda_trans))
    return loss, outputs
...
if __name__ == '__main__':
    ...
    global save_path
    global writer
    with_trans, with_scale = args.with_trans, args.with_scale
    # random seed
    ...
    save_path = os.path.join(args.output_dir,
                             'save_finetuned_affinev2_with_decay', model_name)
    if save_path:
