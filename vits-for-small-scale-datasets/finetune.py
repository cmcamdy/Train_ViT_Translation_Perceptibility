...
def init_parser():
    ...
    parser.add_argument('--output_dir',  default='/work/workspace12/chenhuan/code/outputs/ssloff', type=str, help='dataset path')
...
if __name__ == '__main__':
    ...
    save_path = os.path.join(args.output_dir, 'save_finetuned', model_name)
    if save_path:
