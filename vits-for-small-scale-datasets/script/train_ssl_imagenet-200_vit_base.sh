...
datapath=/work/workspace12/chenhuan/code/datasets/tiny-imagenet-200
pretrained_weights=${root_path}/outputs/ssl/vit_base_imagenet-200/checkpoint.pth
output_dir=/work/workspace12/chenhuan/code/outputs/ssloff/vit_base_imagenet-200
nohup python finetune.py --arch vit  \
                   ...
                   --output_dir ${output_dir} \
                   --tag vfsd_baseline > \
                   ../logs/img200_vfsd_ssl_off.log 2>&1 &
...
nohup python finetune_affine.py --arch vit  \
                   ...
                   --epochs 300 \
                   --output_dir ${output_dir} \
                   --tag baseline_with_trans \
                   --ls --lr 0.002 \
                   --alpha_trans 0.4 \
                   --init_weight 1.2 \
                   --with_trans \
                   > ../logs/img200_baseline_with_trans_ssl_off.log 2>&1 &
...
nohup python finetune_affine.py --arch vit  \
                   ...
                   --epochs 300 \
                   --output_dir ${output_dir} \
                   --tag baseline_with_scale \
                   --ls --lr 0.002 \
                   --alpha_trans 0.4 \
                   --init_weight 1.2 \
                   --with_scale \
                   > ../logs/img200_baseline_with_scale_ssl_off.log 2>&1 &